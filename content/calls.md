...
* Deadline: XXX
* Acceptance notice: YYY
* Final proceedings version: ZZZ

* Registration deadline: AAA
...
We also welcome papers addressing problems such as: combinatorial algorithms, string searching and pattern matching,
sublinear algorithms on massive data sets, network algorithms,
graph algorithms, caching and memory hierarchies, indexing,
